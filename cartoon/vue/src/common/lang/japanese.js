const lang = {
    ...
    "近两月成交单数": "過去2ヶ月間の取引数",
    "近两月成交BTC": "過去2ヶ月間のBTC",
    "享受交易手续费折扣": "取引手数料の割引をお楽しみください",
    "享受提币手续费折扣": "手数料の割引をお楽しみください",
    "会员等级": "会員レベル",
    "等级": "等級",
    "场外交易": "店頭取引",
    "我的等级": "私のレベル",
    ...
    "账户子账号": "アカウントサブ口座",
    "交易子账号": "取引サブ口座",
    "默认财务权限(添加后可以修改权限)": "デフォルトの金融機関（追加後に権限を変更できます）",
    "登录": "ログイン",
    "提现": "出金",
    "_提现": " 出金",
    "充值": "入金",
    "官网": "公式サイト",
    "默认交易权限(添加后可以修改权限)": "デフォルトのトランザクション権限（追加後に権限を変更できます）",
    "默认拥有所有币币交易对的交易": "すべての通貨ペアを含むデフォルト取引",
    "添加": "追加する",
    "必填项": "必須フィールド",
    "邮箱长度为6-32位": "メールボックスの長さは6〜32です",
    "邮箱格式不正确": "メールボックスの形式が正しくありません",
    "密码必须包含数字和字母长度为8-32位": "パスワードには8〜32文字の数字と文字を含める必要があります。",
    "两次输入的密码不一致": "パスワードが2回入力されています",
    "长度为6位": "長さ6桁",
    "机构认证": "機関認証",
    "个人认证": "個人認証",
    "个人已认证": "個人は認証されています",
    ...
    "申请人邮箱": "申請者のメールボックス",
    "切换为手机验证":"電話確認に切り替える",
    "切换为谷歌验证":"Google確認に切り替える",
    "下一步": "次のステップ",
    "通过谷歌表格完成所有资料上传后，请勾选‘我已完善资料’,并点击‘提交申请’按钮完成企业认证申请。如有更多疑问，欢迎发送邮箱至": "Googleフォームを介したすべてのデータのアップロードが完了したら、[データを完成しました]をクリックし、[アプリケーションの送信]ボタンをクリックして企業認定の申請を完了します。 さらに質問がある場合は、にEメールを送ってください ",
    "我已完善详细资料": "私は詳細を完成させました",
    "完善详细信息": "詳細を改善する",
    "您已成功填写企业认证信息，请务必点击一下链接，通过谷歌表格继续完善企业详细资料": "あなたは成功しました、詳細に行きます",
    "上一步": "前のステップ",
    "填写基本信息": "基本情報を記入してください",
    "修改密码": "パスワード変更",
    "提示：您不能在24小时之内提现": "ヒント：24時間以内に引き出すことはできません",
    "旧密码": "旧パスワード",
    "新密码": "新しいパスワード",
    "确认新密码": "新しいパスワードを確認",
    "密码格式不正确": "パスワードの形式が正しくありません",
    "绑定手机号": "電話番号をバインドする",
    "谷歌验证码": "Google確認コード",
    "手机验证码": "携帯電話認証コード",
    "确认": "確認する",
    "手机号码": "携帯電話番号",
    "手机号码：": "携帯電話番号:",
    "更换谷歌密钥": "Googleキーを変更する",
    "验证": "確認する",
    "手机不可用？": "電話は利用できませんか？",
    "谷歌验证不可用？": "Googleの確認は利用できませんか？",
    "设置": "設定",
    "去设置": "設定",
    "你还没有充值过任何资产，充值后的资产会显示在这里哦～":"資産を再請求していません。再請求された資産がここに表示されます",
    "默认语言": "デフォルトの言語",
    "主题": "テーマ",
    "浅色": "明るい色",
    "深色": "ダーク",
    ...
    "更改": "変更",
    "一键购买设置": "ワンクリック購入設定",
    "用于首页快速下单买入": "ホームページクイックオーダー購入用",
    "价格": "価格",
    "仓量": "倉庫 ",
    "一键卖出设置": "ワンクリック販売設定",
    "用于首页快速下单卖出": "ホームページの速い注文を売る",
    "在此输入您需要修改的昵称":"変更する必要があるニックネームをここに入力してください",
    "保存": "保存する",
    "保存失败":"保存できませんでした",
    "保存成功":"保存しました",
    "撤销": "キャンセル",
    "订单撤销成功": "注文は正常にキャンセルされました",
    "订单撤销失败": "注文のキャンセルに失敗しました",
    "默认语言不能为空":"デフォルトの言語は空にできません",
    "限价": "価格を制限する",
    "市价": "市場価格",
    "代表限价委托挂单，限价委托的价格为首页用户点击一键购买/卖出按钮时间所对应的最新价格。": "指値注文に代わって、指値注文の価格は、ホームページユーザが売買のためにボタンをクリックしたときに対応する最新の価格である。",
    "代表用户不指定委托价格，以市场当前最优价格逐步成交": "ユーザーに代わって、コミッション価格は指定されておらず、取引は市場の現在の最適価格で徐々に完了します。",
    "代表用户手里已有的资产按照百分比用于购买或出售另外一种资产": "すでにユーザーに代わっている資産は、パーセンテージとして別の資産を購入または売却するために使用されます。",
    "UBi客户支持永远不会询问你的SMS和谷歌认证码。请不要向任何人透露。": "UBiカスタマーサポートはあなたのSMSとGoogle認証コードを要求しません。 誰にも開示しないでください。",
    "密码": "パスワード",
    "登录时使用": "ログイン時に使用",
    "修改": "修正する",
    "完成身份认证，完善账户安全提现额度": "完全なアイデンティティ認証とアカウントセキュリティの引き出し金額の改善",
    "谷歌认证": "Google認証システム",
    "提现，更改密码和安全中心，以验证谷歌的第二次验证": "キャッシュアウトし、パスワードとセキュリティセンターを変更してGoogleの2回目の確認を確認します",
    "绑定手机": "バインディングフォン",
    "绑定手机，接收安全码，提高账户安全性": "電話機をバインドし、セキュリティコードを受け取り、アカウントのセキュリティを向上させます。",
    "绑定": "製本",
    "用于提现的安全验证": "撤退のためのセキュリティ検証",
    "新建": "新しい",
    "关闭": "閉じる",
    "继续提现":"現金を引き出し続ける",
    "请选择认证类型": "認証の種類を選択してください",
    "联系我们": "お問い合わせ",
    "提示": "プロンプト",
    "24小时内提现额度以BTC估值计算得出": "24時間以内の引き出し金額は、BTC評価に基づいて計算されます",
    "子账号": "サブ口座",
    "提交": "提出する",
    "子账户": "サブ口座",
    "重置手机号": "携帯電話番号を再バインドする",
    "更换手机号码": "携帯電話番号を交換",
    "温馨提示:手机认证更换后24小时内不可以提现": "ヒント：携帯電話の認証は交換後24時間以内に現金化することはできません",
    "确定": "決定する",
    "开启谷歌验证": "Google認証システムを開く",
    "1.下载并安装谷歌验证器APP": "1.Google Authenticator APPのダウンロードとインストール",
    "我已安装好APP": "APPをインストールしました",
    "短信验证码": "電話確認コード",
    "长度为11位": "長さ11ビット",
    "新手机号码": "新しい携帯電話番号",
    "2.使用谷歌验证器APP扫描该二维码": "2.Googleコードをスキャンするには、Google認証システムを使用してください。",
    "如果你无法扫描二维码，可以将16位密钥手动输入到谷歌验证器APP": "QRコードをスキャンできない場合は、手動で16ビットキーをGoogle認証システムに入力できます",
    "我已完成扫描二维码": "QRコードのスキャンを完了しました",
    "3.请将16位密钥记在纸上，并保存在安全的地方。如手机丢失，您可以通过该密钥回复你的谷歌验证": "3. 16ビットキーを紙に書き留め、安全な場所に保管してください。 電話が途絶えた場合は、このキーを使ってGoogle認証システムを復元できます。",
    "通过人工客服重置需提交您的申请工单，可能至少需要7天来处理": "ヒューマンカスタマーサービスでGoogle認証システムを再設定して作業指示を処理するには、少なくとも7日かかります。",
    "我已写下16位密钥": "紙に16ビットキーを記録しました",
    "16位密钥": "16ビットキー",
    "更换": "変化する",
    "开启": "開く",
    "谷歌验证": "Google認証システム",
    "重置谷歌验证": "Google認証システムをリセット",
    "提交成功": "送信しました",
    "我们将在一个工作日内处理，请耐心等待！": "私達は1営業日以内にあなたのためにそれを処理します。 辛抱強く待ってください。",
    "首页": "ホーム",
    "护照ID或驾驶ID": "パスポートのIDまたは運転者のID",
    "护照封面": "身分証明書の正面図",
    "或您可以上传驾驶证正面或者国民身份证正面": "運転免許証の表面をアップロードすることもできます",
    "护照个人信息页": "パスポート個人情報ページ",
    "或您可以上传驾驶证背面或者国民身份证背面": "運転免許証の裏面をアップロードすることもできます。",
    "请确保图片内容完整并且清晰可见，支持jpg、png图片清晰格式": "写真の内容が完全で明確に見えるようにしてください。 jpgまたはpng画像フォーマットがサポートされています..",
    "请手持护照个人信息页和个人签字": "ハンドヘルドパスポートの個人情報ページと個人の署名",
    "或您可以上传驾驶证背面或者国民身份证背面或个人签字": "または、運転免許証と個人の署名の前面をアップロードすることもできます",
    "或请您上传一张手持证件个人信息页和个人签字的照片,个人签字的内容包含和今天的日期，请确保照片和个人签字的内容清晰可见": "個人の身分証明書と個人が署名した写真を含む個人情報ページをアップロードしてください。 個人的に署名されたコンテンツは「UBi.bi」と今日の日付を含みます。 写真の内容と個人の署名がはっきり見えるようにしてください。",
    "上传": "アップロードする",
    "正在上传......": "アップロードしています...",
    "重置手机验证": "携帯電話番号を再バインド",
    "重置": "リセット",
    ...
    "注册": "サインアップ",
    "忘记密码？": "パスワードをお忘れですか？",
    "还不是UBi的用户？": "まだUBiユーザーではない？",
    "立即注册，体验数字货币世界的领先交易平台": "今すぐ登録して、世界をリードするデジタル通貨の取引プラットフォームを体験してください。",
    "我已阅读并同意UBi.Bi": "利用規約を読み、同意 UBi.Biの",
    "已有账号？去": "すでにサインアップ？",
    "服务条款": "利用規約",
    "找回密码": "パスワードを再設定する",
    "你还未添加任何自选":"あなたはお気に入りがありません",
    "返回": "前の",
    "该用户不存在，请重新输入": "このユーザーは存在しません。再入力してください",
    "欢迎来到 UBi.Bi": "UBi.Biへようこそ",
    "最符合您操作习惯的多币种全球交易平台": "運用習慣に最も適した多通貨のグローバル取引プラットフォーム",
    "创建用户": "ユーザーを作成",
    "全天候的服务": "24時間365日のサービス",
    "不仅仅支持7*24H的交易": "7 * 24Hトランザクションをサポートするだけでなく",
    "更有7*24H的客服在线服务": "7 * 24Hカスタマーサービスオンラインサービス",
    "保障您的交易有快速的服务响应": "迅速なサービス対応で取引を保護",
    "资产安全": "資産セキュリティ",
    "我们在数字货币安全领域有全球最顶尖的安全专家研发的私钥离线化、冷钱包技术，保障您的资产存储安全": "デジタル通貨セキュリティの分野では、お客様の資産保管のセキュリティを確保するために、世界のトップセキュリティ専門家によって開発された秘密キーのオフラインおよびコールドウォレットテクノロジがあります。",
    "多币种支持": "多通貨サポート",
    "在这里您可以交易来自全球基于区块链的主流及新兴币种，不再错过任何机会": "ここでは、グローバルなブロックチェーンベースの主流通貨と新興通貨を取引することができます。もうチャンスを逃さない",
    "极速撮合引擎": "スピードマッチングエンジン",
    "我们在撮合引擎技术上使用高速的内存交易引擎以及引擎热备机技术，领先全球各大交易平台，让您交易资产畅通无阻": "マッチングエンジンテクノロジーには、高速メモリートレーディングエンジンとエンジンホットスタンバイテクノロジーを使用しており、世界の主要なトレーディングプラットフォームをリードしています。",
    "交易中心": "거래소",
    "公告中心": "공지사항",
    "客服中心": "顧客サービス",
    "我的资产": "私の資産",
    ...
    "隐藏小额资产": "小バランスを隠す",
    "保留所有权利": "全著作権所有",
    "没有找到任何充值记录":"入金レコードが見つかりません",
    "没有找到任何提现记录":"出金レコードが見つかりません",
    "请查收你的密码重置邮件": "パスワード再設定Eメールを確認してください",
    "我们已经发送了一封重置登录密码电子邮件到您的电子邮件": "あなたのメールアドレスにログインパスワードの再設定メールを送信しました",
    "，请访问您的电子邮件地址。": "、あなたのEメールアドレスを訪問してください。",
    "名字": "お名前",
    "请输入买入量":"購入金額を入力してください",
    "请输入卖出量":"売上高を入力してください",
    "输入关键词搜索，比如 BTC":"入力キーワード検索、例：BTC",
    "姓氏": "姓",
    "国家": "国",
    "护照ID": "パスポートのID ",
    "或者驾驶ID": "または運転手ID",
    ...
    "错误": "エラー",
    "查看原因": "理由を見る",
    "系统升级维护中": "システムはメンテナンス中です",
    "刷新": "更新する",
    "登录密码": "ログインパスワード",
    "温馨提示": "ヒント",
    "设置资金密码": "資金パスワードを設定する",
    "重置资金密码": "資金パスワードをリセットする",
    "1、资金密码用于您在提现时的安全验证；": "1.ファンドパスワードは、出金時のセキュリティ確認に使用されます",
    "2、请准备一个备用手机号码（建议使用您的配偶、父母或者其他亲友的号码）。": "2.予備の携帯電話番号を準備してください（あなたの配偶者、両親または他の親戚の番号を使用することをお勧めします）。",
    "1、资金密码变更后24小时内不能提现，请谨慎操作；": "1.パスワード変更後24時間以内にファンドパスワードを取り消すことはできません。",
    "2、需要您当时设置的备用手机号进行安全验证。":"2.セキュリティ確認のために、その時点で設定した予備の携帯電話番号が必要です。",
    "邮箱验证": "メールボックスの確認",
    "请先": "まずはじめに",
    "开启双重认证": "二要素認証をバインドする",
    "手机验证": "電話による確認",
    ...
    "提现记录": "出金記録",
    "重要提示": "重要な注意",
    "充值地址已发送变更，充值前请确认地址": "入金アドレスは変更のため送信されました。入金の前にアドレスを確認してください。",
    "注意": "注意",
    "委托金额": "合計",
    "充值地址": "入金アドレス",
    "倒计时": "カウントダウン",
    "平台的充值地址已经过期或过期，请不要保存充值地址。如果有一个充值地址，请将工作订单提交给我们": "プラットフォームの入金アドレスが期限切れまたは期限切れです。入金アドレスを保存しないでください。 あなたが再入金アドレスを持っているならば、私達にあなたの作業指示書を提出してください。",
    "最小充值数量0.001，小于最小充值数量将不会记账。": ".最小再入金額は0.001で、最小再入金額より少ない金額は請求されません。",
    "使用": "·使用する",
    "充值完成后，你还可以进入": "·再入金が完了したら、次のように入力することもできます。",
    "充值记录页面": "入金記録ページ",
    "跟踪进度": "進捗状況を追跡する",
    "未KYC身份认证的用户，单次充6.8w美金以上，需认证后才可以交易": "·未KYC身份认证的用户，单次充6.8w美金以上，需认证后才可以交易",
    "未KYC身份认证的用户，近3月累计14w美金充值，需认证后才可以交易": "·KYC認証されていないユーザーは、最近の3月に14wの米ドルを蓄積しており、彼らが取引することができる前に認証される必要があるだけです。",
    "充值实时动态": "リアルタイムダイナミクスの再入金",
    "充值成功": "再入金しました",
    "提现地址": "お引出し先",
    "可用": "有効",
    "实际到账": "実際の到着",
    "最小提现数量": "·最低出金額",
    "请勿直接提现至众筹或TokenSale地址，我们不会处理未来代币的发放": "クラウドファンディングまたはTokenSaleアドレスに直接撤回しないでください、私たちは将来のトークンの発行を処理しません。",
    "提现安全认证": "現金引き出しの安全認証",
    "还差一步：邮箱确认提现": "現金引き出しの安全認証...",
    "系统向您的注册邮箱发送了一封分提现确认邮件，以验证是本人操作，请登录邮箱查收并点击其中的确认链接。": "登録されたメールアドレスに確認メールが送信されますので、そのメールアドレスにログインして確認リンクをクリックしてください。",
    "前往提现记录": "出金記録へ",
    "0资产币": "小バランス",
    "充值记录": "入金記録",
    "热门区块链资产": "その他の通貨",
    "手续费": "費用",
    "地址需要": "アドレスのデポジットが必要",
    "网络确认才能到账": "ネットワーク確認を受け入れることができます",
    "服务邮箱": "サービスメールボックス",
    "支持": "サポート",
    "用户身份认证、提现、交易相关": "ユーザーID認証、出金、入金関連",
    "合作邮箱": "ビジネスメールボックス",
    "上币申请、推广合作相关": "Apply to List, promotion cooperation",
    "重置二次认证": "二要素認証のリセット",
    "请选择重置类型": "リセットの種類を選択",
    "重置谷歌认证": "Google認証システムをリセット",
    "重置手机认证": "SMS認証をリセットする",
    "操作": "操作",
    "24小时提现额度": "24H出金額",
    "原资金密码": "旧資金パスワード",
    ...
    "审核中": "検討中",
    "充值中": "受け取り中",
    "长度不得超过10个字符": "長さは10文字を超えてはいけません",
    "请输入备注": " 備考を入力してください",
    "请输入正确的钱包地址": "正しいウォレットアドレスを入力してください",
    "请输入钱包地址": "ウォレットアドレスを入力してください",
    "包含中文、数字或者字母,长度为1-30位": "長さ1〜30桁の中国語、数字または文字を含む",
    "包含中文、数字或者字母,长度为1-200位": "長さ1〜200桁の中国語、数字または文字を含む",
    "为了您的账户安全，请设置双重身份验证": "アカウントのセキュリティを確保するために、2段階認証プロセスを設定してください",
    "取出现金、更改密码和安全中心，以及验证谷歌的第二次验证": "Google Authenticatorを確認するためのキャッシュアウト、パスワードの変更、およびセキュリティ設定",
    "绑定电话，接收安全码，改善账户安全": "電話のバインド、セキュリティコードの受信、アカウントのセキュリティの向上",
    "恭喜，邮箱可用": "ええ！ メールボックスは利用可能です",
    "对不起，邮箱已经注册": "メールボックスは既に登録されています。",
    "昵称修改成功": "ニックネームの修正に成功しました",
    "头像修改成功": "写真の修正に成功しました",
    "请选择": "選択してください",
    "男": "男性",
    "女": "女性",
    ...
    "状态": "状態",
    "暂无数据": "データなし",
    "最近两个月的交易BTC": "BTC取引の最後の2ヶ月",
    "最近两个月的交易率": "過去2ヶ月間の取引レート",
    "现金交易费用减少率": "現金取引手数料の削減率",
    "用户信息": "アカウント情報",
    "长度为4~11位": "長さ4〜11",
    "最新价": "最新の価格",
    "24H涨跌": "24H変更",
    ...
    "自选": "お気に入り",
    "展开": "広がる",
    "谷歌认证不可用": "Google認証は利用できません",
    "隐藏小于$10美金的资产": "10ドル未満の資産を隠す",
    "涨跌": "変化する",
    "近一周": "1週間近く",
    "近一月": "一ヶ月近く",
    "请设置交易配置": "トランザクション構成を設定してください",
    "申请认证资料已提交，请等待审核": "認証申請が送信されました。確認をお待ちください",
    "成交额": "売上高",
    "买入": "購入",
    "全部撤单": "すべてキャンセル",
    "撤单": "キャンセル",
    ...
    "预估买入数量": "購入予定",
    "预估金额": "合計見積もり",
    "在维修期间暂停交易": "メンテナンス中、取引を中断する",
    "开始计算我的盈亏": "私の損益の計算を始めます",
    "清空盈亏": "明確な損益",
    "去交易": " トレード ",
    "或者": "または",
    'IOS PC 正在研发中':'IOS PCは開発中です',
    'Windows PC 正在研发中':'Windows PCは開発中です',
    'ipad客户端正在研发中':'iPadクライアントは開発中です',
    'pad客户端正在研发中':'パッドクライアントは開発中です',
    "请输入触发价格": "トリガー価格を入力してください",
    "请输入价格": "価格を入力してください",
    "请输入数量": "数量を入力してください",
    "谷歌重置成功": "Googleは正常にリセットされました",
    "现有地址": "購入予定",
    "仓位不足": "バランスが足りない",
    "估计的交易金额不是实际的交易金额，估计的交易金额是从当前最新的交易价格*数量计算的。": "見積取引金額は実際の取引金額ではなく、見積取引金額は現在の最新の取引価格*数量から計算されます。",
    "仓位": "ホールド",
    "审核通过后，将以邮件通知到您": "承認に合格すると、Eメールで通知されます。",
    "重置邮件已经发送到您的邮箱，请查收": "メール送信成功のリセット",
    "卖出": "売る",
    "充值提现记录": "記録",
    "至": "に",
    "导出记录": "輸出記録",
    ...
    "计划委托": "トリガー順序",
    "我的委托": "私の受託",
    "支持PNG、JPG的图片格式": "PNG、JPG画像フォーマットをサポート",
    "24小时历史委托": "24時間の歴史受託",
    "全部": "全部",
    "我的盈亏表示交易币种的盈亏比例，操作列支持快速下单买入或卖出。在个人设置里可以对快速下单进行配置。": "私の損益は取引通貨の損益率を示しており、操作欄は購入または売却の迅速な注文をサポートしています。 クイック発注は個人設定で設定できます。",
    "新消息": "New Message",
    ...
    "已撤消": "Undoed",
    "请填写": "please fill in",
    "密码必须包含数字或字母，长度为6-16位": "パスワードには数字または文字を含める必要があり、長さは6〜16桁です。",
    ...
    "请填写一个有效的提现地址，建议预先绑定地址避免出错":"有効な引き出し先住所を入力してください。間違いを避けるために住所を事前にバインドすることをお勧めします。",
    "UBi工作人员永远不会询问你的SMS和谷歌验证码，请不要向任何人透露。": "UBiのカスタマーサポートはあなたのSMSとGoogle Authenticatorのコードを求めません。 誰にも公開しないでください。",
    "快速交易": "Quick Orders",
    "用于登录": "For login",
    ...
    "邮箱已注册": "既に登録されているメールアドレス",
    "邮箱不可用": "メールが利用できません",
    "手机重置成功": "携帯電話のリセットに成功しました",
    "已设置": "設定済み",
    "未设置": "設定しない",
    ...
    "您的专属推荐地址":"排他的なプロモーションアドレス",
    "活动规则":"規則",
    "推广规则一":"ユニークな招待状のリンクを受け取るためにサインアップしてください、あなたの独占的なリンクを通して登録するようにあなたの友人を招待してください;",
    "推广规则二":"たとえば、昨日招待された友人が0.1BTCの手数料を生成した場合、現在の手数料の20％に応じて、0.02BTCを取得できます;",
    "推广规则三":"友人が登録に招待されるたびに、コインはイベントのルールに従って無料で送付されます;",
    "推广规则四":"その日のリベート賞金は翌日の午前1時に決済され、決済後1時間以内にあなたのUBiアカウントに発行されます。",
    "UBi将严厉打击作弊行为，一经发现，将不会支付返利佣金":"劉（UBi）は不正行為を取り締まって一旦発見されたリベートプロモーション料金を支払わないことです。",
    "平台保留对该活动进行调整和解释的最终权利，届时将另行公告":"プラットフォームは、イベントを調整し、解釈することができる最終的な権利を保有し、別途発表されます。",
    "提币处理中": "引き出し処理",
    "提币成功": "撤回しました",
    "网络异常，地址无法获取":"ネットワークがビジー、アドレス取得に失敗",
    "累计邀请人数":"招待者の累積数",
    "最小交易金额":"最小取引金額",
    "该币种暂未开放交易":"まだ取引のために開かれていません",
    "MEMO和提现地址同时使用才能提现": "撤回するには、メモを使用して住所を撤回する必要があります",
    "MEMO和充值地址同时使用才能充值": "入金するには、MEMOと住所を入金する",
    "网络断开，请稍后重试": "ネットワークが切断されました。 後でもう一度やり直してください。",
    "重置成功后，24小时内不允许提现": "リセットに成功してから24時間以内に出金することはできません。",
    "请输入交易币种": "暗号通貨を入力してください",
    "客户端下载": "クライアントダウンロード",
    "欢迎来到UBi": "UBiへようこそ",
    "资产管理": "私の資産",
    "资产估值": "総資産評価",
    ...
    "PC客户端":"PCクライアント",
    "强大的交易平台，最全面的币种类型":"強力な取引プラットフォーム、最も包括的な通貨タイプ",
    "听取用户的需求，让交易数字币安全又快速。支持多种主流货币。":"ユーザーのニーズに耳を傾け、デジタル硬貨の取引を安全かつ迅速にします。 主流のさまざまな通貨をサポートします。",
    "数据分析": " データ解析",
    "币种介绍": " 通貨の紹介",
    "币种讯息": " ニュース",
    '官方动态':' 通貨メッセージ',
    ...
    "安全建议：您当前是还未完成双重认证（认证手机号码或谷歌安全密钥），许多功能将受到限制。":"セキュリティに関するヒント：あなたは現在二重認証（認証された携帯電話番号またはGoogleセキュリティキー）を完了していないため、多くの機能が制限されます。",
    "未双重认证的账户，资产没有安全保障，账户被盗的风险高；":'二重認証口座はなく、資産は保護されておらず、口座窃盗のリスクは高いです。',
    "未双重认证的账户，提现功能受到限制；":'二重認証口座がない場合、引き出し機能は制限されます。',
    "未双重认证的账户，不允许设置资金密码；":'二重認証を持たないアカウントは、ファンドパスワードを設定することができません。',
    "去安全中心设置":'セキュリティセンターの設定に移動します',
    "安全建议：您当前是游客账户，请尽快绑定邮箱，否则许久不登录，账户将被收回。": "セキュリティの提案：あなたは現在ビジターアカウントです。できるだけ早くメールボックスをバインドしてください。そうしないと、長期間ログインしないとアカウントが再利用されます。",
    "没有绑定邮箱的账户，提现功能受到限制;": "メールボックスにバインドされたアカウントがない場合、引き出し機能は制限されています。",
    "没有绑定邮箱的账户，无法接收邮件通知;": "メールボックスにバインドされているアカウントがない場合、電子メール通知を受信できません。",
    "没有绑定邮箱的账户，不能重置手机号或者谷歌密钥;": "メールボックスが添付されたアカウントがないと、電話番号やGoogleキーをリセットすることはできません。",
    "没有绑定邮箱的账户，无法找回账户，造成的资产损失与UBi无关;":"メールボックスにバインドされたアカウントがない場合、そのアカウントは取得できず、その結果生じる資産の損失はUBiとは無関係です。",
    "绑定邮箱": "メールをバインド",
    "没有邮箱？": "メールなし?",
    "游客登录":"観光ログイン",
    "{name}入场":"店頭取引",
    ...
    '请确认您正在访问':'あなたが訪問していることを確認してください',
    '退出登录':'ログアウト',
    '安全中心':'セキュリティ',
    "立即注册":"サインアップ",
    "或":"または",
    ...
    "我已付款":"I have paid",
    "取消订单":"Cancel order",
    "开源代码仓库":"オープンソースコードリポジトリ",
    "支持的钱包":"サポート財布",
    "官网:":"公式サイト:",
    "白皮书":"白書",
    "缓存清理成功":"キャッシュクリーニングが成功した",
    "未绑定邮箱":"Unbound mail",
